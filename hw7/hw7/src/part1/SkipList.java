 ...
 * 
 * I added the iterator class to the skiplist class. According to SkipList.
 * 
...
public class SkipList<E extends Comparable<E>> implements SearchTree<E> {
	...
	/**
	 * This inner class is the SkipList iterator class. I override the hasNext, next
	 * methods from the Iterator interface. I wrote no parameter constructor. I set
	 * the origin and index in it.
	 * 
	 * @author 1801042103
	 *
	 */
	private class SkipListIterator implements Iterator<E> {
		private SLNode<E> iter;
		private int index = 0;
		...
		/**
		 * This method allows me to return to the end of the skiplist with iterator.
		 * 
		...
		public boolean hasNext() {
			...
			return iter.links[index] != null;
		}

		/**
		 * This method return next node of value.
		 * 
		 * @return E value
		 */
		@Override
		public E next() {
			return (iter = iter.links[index]).data;
		}
	}
	...
	/**
	 * Method to compute the maximum capacity, given the maximum level. It computes
	 * Math.pow(2, maxLevel) - 1, using shift.
	 *
	 ...
	 * I.E. 1/2 values returned are 1, 1/4 are 2, 1/8 are 3, 1/16 are 4, etc.
	 *
	 ...
	 * @return A SLNode array which references the nodes preceeding the sought item
	 *         at each level.
	 */
