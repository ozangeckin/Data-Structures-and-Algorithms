...
// Data Fields
	...
	/**
	 * Recursive add method. Inserts the given object into the tree. post: addReturn
	...
	private AVLNode<E> rebalanceLeftR(AVLNode<E> localRoot) {
		...
		if (leftChild.balance < AVLNode.BALANCED) {
			/*
			 * In this case both the leftChild (the new root) and the root (new right child)
			 * will both be balanced after the rotate. Also the overall height will be
			 * reduced, thus increase will be fasle, but decrease will be true.
			 */
			leftChild.balance = AVLNode.BALANCED;
			...
			/*
			 * After the rotate the leftChild (new root) will be right heavy, and the local
			 * root (new right child) will be left heavy. The overall height of the tree
			 * will not change, thus increase and decrease remain unchanged.
			 */
	...
	private AVLNode<E> rebalanceRightL(AVLNode<E> localRoot) {
		...
		if (rightChild.balance > AVLNode.BALANCED) {
			...
			/*
			 * After the rotate the rightChild (new root) will be left heavy, and the local
			 * root (new left child) will be right heavy. The overall height of the tree
			 * will not change, thus increase and decrease remain unchanged.
			 */
