...
// Data Fields
	...
	/**
	 * Recursive add method. post: The data field addReturn is set true if the item
	 * is added to the tree, false if the item is already in the tree.
	 * 
	...
	/**
	 * Recursive delete method. post: The item is not in the tree; deleteReturn is
