...
public class KWLinkedList<E> {
	...
	/**
	 * This method add element in last node
	 * 
	 * @param data E
	 * @return boolean
	 */
	...
	/**
	 * This method search for obj in nodes and remove it if find it. It update
	 * linkedList.Updating Next and Prev
	 * 
	 * @param obj E
	 * @return boolean
	 */
	public boolean remove(E obj) {
		if (head == null) {
			...
			while (prevNode != tail && !prevNode.next.data.equals(obj)) {
	...
	/**
	 * This method data from a special index and deletes the node if it is found.
	 * 
	 * @param index specificed position
	 * @return E
	 */
	...
	/**
	 * Getter for size of KWLinkedList
	 * 
	 * @return size size of KWLinkedList
	 */
	public int getSize() {
		return size;
	}
	...
	/**
	 * Setter of size of KWLinkedList
	 * 
	 * @param size size of KWLinkedList
	 */
	...
	private class KWListIter implements ListIterator<E> {
		...
		/**
		 * Remove the last item returned. This can only be done once per call to next or
		 * previous.
		 * 
		 * @throws IllegalStateException if next or previous was not called prior to
		 *                               calling this method
		 */
		public void remove() {
